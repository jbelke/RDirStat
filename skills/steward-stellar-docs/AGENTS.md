...
| Path | Owns |
| --- | --- |
| `SKILL.md` | The binding procedure: scan first, work the buckets in order, never lose snapshot content without a decision, index `reference-code/` instead of adopting it |
