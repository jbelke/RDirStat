...
# can prove the committed icons are the ones the source describes. `iconutil`
# is macOS-only, so icon.icns is regenerated by `./rush.sh icons` on a Mac and
# checked here only for presence.
# ---------------------------------------------------------------------------
